...
class BackupManager {
    ...
    function __construct() {
        ...
        $this->_backupLocation = $ne_config_info['backup_root'];
        $this->_backupType = $ne_config_info['backup_type'];
        $this->_navindex_backup_path = $ne_config_info['navindex_backup_dir'];
    }
