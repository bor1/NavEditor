	...
	<div id="wrapper">
		...
		<div id="textbereich">
				...
				<p>
					...
					Der <?php echo($ne_config_info['app_title']); ?> wurde im Rahmen des <a class="extern" href="http://www.vorlagen.uni-erlangen.de">Webbaukastens der Friedrich-Alexander-Universit&auml;t</a>
					entwickelt.
				...
				<p>
				Der <?php echo($ne_config_info['app_title']); ?> verwendet einige &ouml;ffentliche Ressourcen und Plugins:
				</p>
				<ul>
