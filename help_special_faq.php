...
<body>
    ...
    <div class="container page" id="wrapper">
		<div class="page-header">
			<h2 class="page-header">Spezielle Fragen und Antworten</h2>
		</div>
		...
		<p>Fragen und Antworten finden Sie unter:</p>
		<ul>
			<li><a class="extern" href="https://www.helpdesk.rrze.uni-erlangen.de/otrs/public.pl?Action=PublicFAQExplorer;CategoryID=44">RRZE-Helpdesk speziell zum Webbaukasten</a></li>
			<li></u><a class="extern" href="https://www.helpdesk.rrze.uni-erlangen.de/otrs/public.pl?Action=PublicFAQExplorer;CategoryID=101">RRZE-Helpdesk speziell zum NavEditor</a></li>
		</ul>
		<p>&Uuml;ber das Helpdesk-System k&ouml;nnen Sie bereits gemeldete Probleme suchen oder den Status laufender Vorf&auml;lle abfragen. </p>
